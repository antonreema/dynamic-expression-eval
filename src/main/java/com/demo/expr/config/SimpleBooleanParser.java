...
public class SimpleBooleanParser extends Parser {
	...
	public static class TextExpressionContext extends ExpressionContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SimpleBooleanListener ) ((SimpleBooleanListener)listener).enterTextExpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SimpleBooleanListener ) ((SimpleBooleanListener)listener).exitTextExpression(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleBooleanVisitor ) return ((SimpleBooleanVisitor<? extends T>)visitor).visitTextExpression(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ComparatorContext extends ParserRuleContext {
		...
		public TerminalNode NOTIN() { return getToken(SimpleBooleanParser.NOTIN, 0); }
		public TerminalNode STARTSWITH() { return getToken(SimpleBooleanParser.STARTSWITH, 0); }
		public TerminalNode ENDSWITH() { return getToken(SimpleBooleanParser.ENDSWITH, 0); }
		public TerminalNode NULL() { return getToken(SimpleBooleanParser.NULL, 0); }
		public TerminalNode NOTNULL() { return getToken(SimpleBooleanParser.NOTNULL, 0); }
	...
	public final ComparatorContext comparator() throws RecognitionException {
		...
		try {
			...
			setState(39);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << GT) | (1L << GE) | (1L << LT) | (1L << LE) | (1L << EQ) | (1L << NE) | (1L << IN) | (1L << NOTIN) | (1L << STARTSWITH) | (1L << ENDSWITH) | (1L << NULL) | (1L << NOTNULL))) != 0)) ) {
	...
	public static final String _serializedATN =
		...
		"\24\2\2\21\22\5\4\3\2\22\23\7\25\2\2\23\33\3\2\2\2\24\25\7\5\2\2\25\33"+
		"\5\4\3\t\26\33\5\n\6\2\27\33\7\27\2\2\30\33\7\26\2\2\31\33\7\30\2\2\32"+
